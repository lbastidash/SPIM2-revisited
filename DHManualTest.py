...
endProcces="N"
while True:
    editableFouriershape= input("input the desired size of the phase mask (a number):")
    #HelixPhaseMask
    fshape=int(editableFouriershape)
    ogMask = make_now.generate_corkscrew_optimized(int(fshape/2))
